...
#Esse é o aspecto de uma distribuição t com n=53 observações e com n - 1 graus de 
...
#Como os valores são gerados aleatoriamente poderemos ter curvas diferentes para um mesmo valor de n, mas a 
#medida que n cresce o comportamento simétrico tende a estabilizar.
